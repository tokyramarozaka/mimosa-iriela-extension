package graph.aStar_planning.pop.utils.components;
...
public class Step implements PlanElement {
     ...
     * @return true if there the current codenotation constraints can unify the two propositions
    ...
    /**
     * Checks if a step is the final dummy step
